...
namespace BazaDannih {
    ...
    public partial class Database1DataSet1 : global::System.Data.DataSet {
        ...
        public partial class StudentDataTable : global::System.Data.TypedTableBase<StudentRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "18.0.0.0")]
            public StudentRow AddStudentRow(string LastName, string FirstName) {
...
namespace BazaDannih.Database1DataSet1TableAdapters {
    ...
    public partial class StudentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Student] WHERE (([StudentID] = @Original_StudentID) AND ([Last" +
                "Name] = @Original_LastName) AND ([FirstName] = @Original_FirstName))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Student] ([LastName], [FirstName]) VALUES (@LastName, @FirstNa" +
                "me);\r\nSELECT StudentID, LastName, FirstName FROM Student WHERE (StudentID = SCOP" +
                "E_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Student] SET [LastName] = @LastName, [FirstName] = @FirstName WHERE (([StudentID] = @Original_StudentID) AND ([LastName] = @Original_LastName) AND ([FirstName] = @Original_FirstName));
SELECT StudentID, LastName, FirstName FROM Student WHERE (StudentID = @StudentID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::BazaDannih.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT StudentID, LastName, FirstName FROM dbo.Student";
        ...
        public virtual int Delete(int Original_StudentID, string Original_LastName, string Original_FirstName) {
        ...
        public virtual int Update(string LastName, string FirstName, int Original_StudentID, string Original_LastName, string Original_FirstName, int StudentID) {
            if ((LastName == null)) {
                throw new global::System.ArgumentNullException("LastName");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string LastName, string FirstName, int Original_StudentID, string Original_LastName, string Original_FirstName) {
            return this.Update(LastName, FirstName, Original_StudentID, Original_LastName, Original_FirstName, Original_StudentID);
        }
    }
